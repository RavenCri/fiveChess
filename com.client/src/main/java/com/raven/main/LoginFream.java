...
public class LoginFream extends JFrame{
	...
	public LoginFream(BeginWindow bWindow){
		...
		loginIcon =new ImageIcon(GamePlane.class.getResource("/source/login.png"));
		...
		bg= new JLabel(new ImageIcon(GamePlane.class.getResource("/source/aa.jpg"))); 
		bg.setLayout(null);
			...
			public void actionPerformed(ActionEvent e) {
				...
				new Thread() {
					public void run() {
						...
						String staus[] = HttpConnectUtil.requestHTTP(BeginWindow.host+"/login",msg,"post").split(":");
