...
public class Room extends JFrame {
	...
	static ImageIcon man = new ImageIcon(GamePlane.class.getResource("/source/man.jpg"));
	static ImageIcon women = new ImageIcon(GamePlane.class.getResource("/source/women.jpg"));
	public static ImageIcon chessWhite = new ImageIcon(GamePlane.class.getResource("/source/chessWhite.png"));
	public static ImageIcon chessBlack = new ImageIcon(GamePlane.class.getResource("/source/chessBlack.png"));
