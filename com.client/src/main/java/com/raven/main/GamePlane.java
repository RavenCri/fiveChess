...
public class GamePlane extends JSplitPane implements MouseListener{
	...
	static ImageIcon stopImage  = new ImageIcon(GamePlane.class.getResource("/source/stop.png"));
	static ImageIcon bgImage  = new ImageIcon(GamePlane.class.getResource("/source/bgImage.jpg"));
	static ImageIcon chatImage = new ImageIcon(GamePlane.class.getResource("/source/chat.png"));
	//static ImageIcon moveImage = new ImageIcon(GamePlane.class.getResource("/source/move.png"));
	static ImageIcon beginBG = new ImageIcon(GamePlane.class.getResource("/source/bfmusic.png"));
	static ImageIcon StopBG = new ImageIcon(GamePlane.class.getResource("/source/stopmusic.png"));
	...
	ImageIcon man = new ImageIcon(GamePlane.class.getResource("/source/man.jpg"));
	ImageIcon women = new ImageIcon(GamePlane.class.getResource("/source/women.jpg"));
	...
	public GamePlane() {
		...
		try {
			...
			qizi = ImageIO.read(GamePlane.class.getResourceAsStream("/source/qizi.png"));
	...
	public void paint(Graphics g) {
		...
		GameClient.pool.execute(new PaintMoveChess(bf,g,g2,this));
				...
				if(chessBoard.RoomType.equals("CreateRoom")) {
					//判断时候准备了
						...
						if(zhunbei) {
							...
							GameRoomUtil.palyothermusic("/sourcebegin.mp3");
						}else {
							if(!gameplayer2.equals("")) {
